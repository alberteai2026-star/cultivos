...
- [x] M22.S2 Export PDF/Excel
- [x] M22.S3 Firma agrónomo
- [x] M22.S4 Plantillas reutilizables de reportes
- [x] M22.S5 Generación de exportaciones desde plantilla

### M23 — IA
- [x] M23.S1 Recomendaciones agronómicas
- [x] M23.S2 Predicción de rendimiento
- [x] M23.S3 Alertas predictivas

### M24 — Auditoría
- [ ] M24.S1 Log de acciones
- [x] M24.S2 Filtros forenses y resumen agregado
- [x] M24.S3 Export y verificación de firma (integridad básica)
